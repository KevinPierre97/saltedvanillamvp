    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            if not User.objects.filter(email=email_id).exists():
                ...
                self.stdout.write('----------')
                self.stdout.write(f'Welcome to Salted Vanilla\'s first beta, {gen_username}')
                ...
                self.stdout.write('All data you choose to enter may be wiped before V1 is released')
